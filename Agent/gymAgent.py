...
class GymLearner():
    ...
    def run(self):
        ...
        add_dict={
        'actor': {'fc': [50, 100, 50], 'lr': 1e-4, 'lr_decaying_epoch': 50, 'lr_decaying_rate': 0.8, 'tau': 0.001},
        'critic': {'fc': [50, 100, 50], 'lr': 1e-3, 'lr_decaying_epoch': 50, 'lr_decaying_rate': 0.8, 'tau': 0.001},
        'experience_replay_size': 1e5,
        'batch_size': 64,
        'ou': {'theta': 0.15, 'sigma': 0.2, 'mu': 0.0},
        'gamma': 0.999,
        'action_space': [-1, 1],'init_train_ddpg':3000,
        }
